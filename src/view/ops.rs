...
use crate::matrixable::MatrixLike;
    ...
    T: Add<U>,
{
    ...
    fn add(self, other: MatrixView<U>) -> Self::Output {
        ...
        MatrixView::new(data, self.c, self.r)
    }
}
    ...
    fn mul(self, rhs: MatrixView<U>) -> Self::Output {
        if self.is_one_dimension() && rhs.is_one_dimension() {
            if self.size() == rhs.size() {
                ...
                return MatrixView::new(d, self.r, self.c);
            }
            else {
    ...
    T: Mul<U>
{
    ...
    fn mul(self, rhs: U) -> Self::Output {
        ...
        MatrixView::new(d, self.r, self.c)
    }
}
