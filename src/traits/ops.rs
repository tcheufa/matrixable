    ...
    T: Add<U>,
{
    ...
    fn add(self, other: MatrixView<U>) -> Self::Output {
        ...
        MatrixView::new(data, self.c, rows)
    }
}
    ...
    fn mul(self, rhs: MatrixView<U>) -> Self::Output {
        ...
        if self.is_one_dimension() && rhs.is_one_dimension() {
            if self.size() == rhs.size() {
                ...
                return MatrixView::new(d, self_rows, self.c);
            }
            else {
        ...
        let (r, c) = (self_rows, rhs.num_cols());
        ...
        $(
                ...
                $ty: Mul<T>
            {
                ...
                fn mul(self, rhs: MatrixView<T>) -> Self::Output {
                    ...
                    let rows = rhs.num_rows();
                    for x in rhs.d {
                        d.push(self * x);
                    }

                    MatrixView::new(d, rows, rhs.c)
                }
            }
