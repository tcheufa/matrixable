...
pub trait Matrix
{
    ...
    ///
    /// [`get_nth`]: crate::traits::Matrix::get_nth
    ...
    /// Creates from matrix a matrix where access to elements is defined by an [`AccessStrategy`].
    ///
    /// [`AccessStrategy`]: crate::traits::req::AccessStrategy
